...
# o imprime com a primeira letra maiúscula. Esta lambda deverá ser salva dentro de uma variável
...
lambda_capitalize = ->(text) { puts text.capitalize }

def capitalize_name(lbda)
  lbda.call('conhecendo')
  lbda.call('ruby')
end
